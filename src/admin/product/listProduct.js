...
const ProductList = () => {
  ...
  return (
      <div className="flex flex-col">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {product?.map((item, index) => {
                                    return <tr key={index}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            {item.categoryId == "1" ? "Giày Adidas":item.categoryId =="2" ? "Bóng Adidas":'Bóng Adidas'}
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            {item.quantity}
                                        </td>
            ...
            <a href="/admin/product/add" className="text-gray-300 bg-blue-700 hover:bg-black-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Thêm San Pham</a>
        </div>
  )
}
